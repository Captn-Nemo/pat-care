...
export const ADD_NURSINGSTATIONS = "ADD_NURSINGSTATIONS";
export const ADD_CATEEGORIES = "ADD_CATEEGORIES";

export const REMOVE_DEPARTMENTS = "REMOVE_DEPARTMENTS";
export const REMOVE_DESIGNATIONS = "REMOVE_DESIGNATIONS";
export const REMOVE_NURSINGSTATIONS = "REMOVE_NURSINGSTATIONS";
export const REMOVE_CATEEGORIES = "REMOVE_CATEEGORIES";
